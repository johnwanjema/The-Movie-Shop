    ...
    <section>
        ...
        <div class="container-fluid">
            ...
            <div style="padding-bottom:100px" class="row">
                <div v-for="(movie,i) in popularShows.results" :key="i" class="col-md-3 movie">
...
export default {
    ...
    computed: {
        ...mapGetters(['popularShows']),
        rows() {
            return this.popularShows.total_pages
        }
    },
    methods: {
        searchMovie: _.debounce(function() {
            axios
                ...
                .then( ({data})  => {
                    this.$store.commit('setPopularShows', data)
                    console.log(data)
                })
        }, 1000),
    ...
    mounted() {
        this.$store.dispatch('popularShows');
    }
};
</script>
